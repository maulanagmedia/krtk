...
//        super.onMessageReceived(remoteMessage);
    ...
    private void sendNotification(String title, String body , HashMap<String, String> extra) {
        ...
        int IconColor = getResources().getColor(gmedia.net.id.notificationfirebase.R.color.color_notif);

        // Set Notification
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                .setSmallIcon(gmedia.net.id.notificationfirebase.R.drawable.ic_notif)
                .setColor(IconColor)
