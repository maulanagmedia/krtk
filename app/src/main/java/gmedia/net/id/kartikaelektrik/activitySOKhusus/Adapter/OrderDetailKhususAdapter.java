...
public class OrderDetailKhususAdapter extends ArrayAdapter {
    ...
    public OrderDetailKhususAdapter(Activity context, List<SalesOrderDetail> items, HashMap<String, String> stringList, String status) {
