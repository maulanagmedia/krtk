...
import gmedia.net.id.kartikaelektrik.activitySOKhusus.ListBarangSalesOrderKh;
...
public class ListCustomerOrderKhususAdapter extends ArrayAdapter {
    ...
    public ListCustomerOrderKhususAdapter(Activity context, int resource, List<Customer> customerList) {
...
//        if(position % 2 != 0) convertView.setBackgroundColor(backgroundcolor);
    ...
    private void showCategory(String kdCus, String customerName, String tempo){
        ...
        Intent intent = new Intent(context, ListBarangSalesOrderKh.class);
