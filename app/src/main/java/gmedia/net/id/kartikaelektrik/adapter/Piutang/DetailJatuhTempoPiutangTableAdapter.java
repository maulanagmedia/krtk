...
public class DetailJatuhTempoPiutangTableAdapter extends ArrayAdapter {
    ...
    public DetailJatuhTempoPiutangTableAdapter(Activity context, int resource, List items) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            if(tipeViewList == 0){
                ...
                convertView = inflater.inflate(R.layout.adapter_detail_piutang_jatuhtempo, null);
