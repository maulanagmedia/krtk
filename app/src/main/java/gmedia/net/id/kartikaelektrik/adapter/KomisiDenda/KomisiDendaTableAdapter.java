package gmedia.net.id.kartikaelektrik.adapter.KomisiDenda;
...
public class KomisiDendaTableAdapter extends ArrayAdapter {
    ...
    public KomisiDendaTableAdapter(Activity context, int resource, List<CustomListItem> items) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            if(tipeViewList == 0){
                ...
                convertView = inflater.inflate(R.layout.adapter_komisi_denda, null);
