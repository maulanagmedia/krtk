...
import gmedia.net.id.kartikaelektrik.activitySetoran.Adapter.MutasiSetoranAdapter;
import gmedia.net.id.kartikaelektrik.model.CustomListItem;
import gmedia.net.id.kartikaelektrik.util.ApiVolley;
import gmedia.net.id.kartikaelektrik.util.ItemValidation;
import gmedia.net.id.kartikaelektrik.util.ServerURL;

public class MutasiSetoran extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mutasi_setoran);
    ...
    private void initEvent() {
        ...
        fabAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, DetailMutasiSetoran.class);
    ...
    public static void getDataSetoran() {
        ...
        ApiVolley request = new ApiVolley(context, jBody, "POST", ServerURL.getMutasiSetoran, "", "", 0, new ApiVolley.VolleyCallback() {
            @Override
    ...
    private static void setAdapter(List<CustomListItem> listItem) {
        ...
        if(listItem != null && listItem.size() > 0){
            ...
            MutasiSetoranAdapter adapter = new MutasiSetoranAdapter((Activity) context, listItem);
