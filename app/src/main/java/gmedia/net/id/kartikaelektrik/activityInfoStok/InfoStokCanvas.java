...
public class InfoStokCanvas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_info_stok_canvas);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getWindow().setSoftInputMode(
                WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN
        );
        setTitle("Informasi Stok Canvas");
        initUI();
    }
    ...
    public void getBarangAutocomplete() {
        ...
        ApiVolley restService = new ApiVolley(InfoStokCanvas.this, jsonBody, "POST", urlInfoStok , "", "", 0,
                    ...
                    public void onSuccess(String result){
                        ...
                        try {
                            ...
                            for(int i = 0; i < arrayJSON.length();i++){
                                ...
                                listMasterBarang.add(new Barang(jo.getString("kdbrg"),jo.getString("namabrg"),jo.getString("stok") + " " + jo.getString("satuan"),jo.getString("hargajual"), "", ""));
                            }
    ...
    private void getListBarangAutocomplete(List<Barang> listItems){
        ...
        if (listItems != null && listItems.size() > 0){
            ...
            arrayAdapterString = new BarangAdapter(InfoStokCanvas.this,listItems.size(),listItems);
                            ...
                            new TimerTask() {
                                ...
                                public void run() {
                                    ...
                                    if(counter == editable.length() && !itemWasSelected){
                                        InfoStokCanvas.this.runOnUiThread(new Runnable() {
                                            @Override
                                            public void run() {
                                                filterIndex = "0";
                                                getBarangAutocomplete();
        ...
        actvNamaBarang.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                if(actionId == EditorInfo.IME_ACTION_SEARCH){
                    ...
                    getBarangAutocomplete();
                    iv.hideSoftKey(InfoStokCanvas.this);
                    return true;
                }
                return false;
            }
    ...
    private void getListBarangTable(List<Barang> listItems){
        ...
        if (listItems != null && listItems.size() > 0){
            ...
            tableAdapter = new InfoStokAdapter(InfoStokCanvas.this,listItems.size(), listItems, "canvas");
                    ...
                    new ApiVolley.VolleyCallback(){
                        ...
                        public void onSuccess(String result){
                            ...
                            try {
                                ...
                                for(int i = 0; i < arrayJSON.length();i++){
                                    JSONObject jo = arrayJSON.getJSONObject(i);
                                    addList.add(new Barang(jo.getString("kdbrg"),jo.getString("namabrg"),jo.getString("stok") + " " + jo.getString("satuan"),jo.getString("hargajual"), "", ""));
                                }
