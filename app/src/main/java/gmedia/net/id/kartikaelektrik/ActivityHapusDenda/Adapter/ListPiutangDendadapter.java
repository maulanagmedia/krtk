package gmedia.net.id.kartikaelektrik.ActivityHapusDenda.Adapter;
...
public class ListPiutangDendadapter extends ArrayAdapter{

    private Activity context;
    private List<OptionItem> items;
    private ItemValidation iv = new ItemValidation();

    public ListPiutangDendadapter(Activity context, List<OptionItem> items) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.tvItem1.setText(iv.ChangeFormatDateString(itemSelected.getAtt1(), formatDate, formatDateDisplay));
        ...
        holder.cbItem.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                ((DetailDendaCustomerActivity) context).updateTotal();
            }
        });
