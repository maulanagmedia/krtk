...
public class ReturSelisihNotaAdapter extends ArrayAdapter {
    ...
    public ReturSelisihNotaAdapter(Activity context, int resource, List items) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            if(tipeViewList == 0){
                ...
                convertView = inflater.inflate(R.layout.adapter_retur_selisih_nota, null);
                holder.tvItem1 = (TextView) convertView.findViewById(R.id.tv_item_1);
