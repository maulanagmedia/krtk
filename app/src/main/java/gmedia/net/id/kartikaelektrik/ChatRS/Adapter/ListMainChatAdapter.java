...
public class ListMainChatAdapter extends ArrayAdapter {

    private Activity context;
    private List<CustomListItem> items;
    private ItemValidation iv = new ItemValidation();

    public ListMainChatAdapter(Activity context, List<CustomListItem> items) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.tvTime.setText(iv.ChangeFormatDateString(itemSelected.getListItem5(), FormatItem.formatTimestamp, FormatItem.formatDateDisplay2));
