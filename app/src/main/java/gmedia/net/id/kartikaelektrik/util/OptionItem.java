...
public class OptionItem {
    ...
    public OptionItem(String value, String text, String att1, String att2, String att3, boolean selected) {
        this.value = value;
        this.text = text;
        this.att1 = att1;
        this.att2 = att2;
    ...
    public OptionItem(String value, String text, String att1, String att2, String att3, String att4, boolean selected) {
        this.value = value;
        this.text = text;
        this.att1 = att1;
        this.att2 = att2;
