...
public class OmsetPerCustomerTableAdapter extends ArrayAdapter {
    ...
    public OmsetPerCustomerTableAdapter(Activity context, int resource, List items, int type) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            if(typeView == 1){ // Main
                ...
                convertView = inflater.inflate(R.layout.adapter_omset_percustomer, null);
                ...
                convertView = inflater.inflate(R.layout.adapter_omset_barangnota, null);
                holder.tvItem1 = (TextView) convertView.findViewById(R.id.tv_item_1);
                holder.tvItem2 = (TextView) convertView.findViewById(R.id.tv_item_2);
                holder.tvItem3 = (TextView) convertView.findViewById(R.id.tv_item_3);
                holder.tvItem4 = (TextView) convertView.findViewById(R.id.tv_item_4);
        ...
        if(typeView == 1){
            ...
            holder.tvItem5.setText(item.getListItem5());
            holder.tvItem6.setText(item.getListItem6());
