...
public class LabaRugiOmsetJual extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laba_rugi_omset_jual);
    ...
    private void getData(String year) {
        ...
        ApiVolley restService = new ApiVolley(context, jsonBody, "POST", ServerURL.getLabaRugiOmsetJual, "", "", 0,
