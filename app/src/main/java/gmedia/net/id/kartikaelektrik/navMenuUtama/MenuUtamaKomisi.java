...
import gmedia.net.id.kartikaelektrik.activityKomisi.KomisiPembayaran;

/**
 * Created by Shin on 2/1/2017.
 */

public class MenuUtamaKomisi extends Fragment {
    ...
    private String[] jenisTanggal = new String[2];
    private String TAG = "KOMISI";
    ...
    public MenuUtamaKomisi(){}

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        layout = inflater.inflate(R.layout.menu_utama_komisi, container, false);
        context = getActivity();
        initUI();
        return layout;
    }
