...
public class ReturDatePicker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retur_date_picker);
    ...
    private void initValidation() {
        ...
        iv.datePickerEvent(ReturDatePicker.this, edTanggalAwal, "RIGHT", formatDateDisplay, tanggalAwalH);
        iv.datePickerEvent(ReturDatePicker.this, edtTanggalAkhir, "RIGHT", formatDateDisplay);
    ...
    private void validateTampilkan() {
        ...
        switch(flag){
            case MenuUtamaRetur.returCustomer:
                intent = new Intent(ReturDatePicker.this, ReturCustomer.class);
                intent.putExtra("tanggalawal", tanggalAwal);
                intent.putExtra("tanggalakhir", tanggalAkhir);
                break;
            case MenuUtamaRetur.returTelahDiproses:
                intent = new Intent(ReturDatePicker.this, ReturTelahDiproses.class);
                intent.putExtra("tanggalawal", tanggalAwal);
                intent.putExtra("tanggalakhir", tanggalAkhir);
                break;
            case MenuUtamaRetur.returSelisihNota:
                intent = new Intent(ReturDatePicker.this, ReturSelisihNota.class);
                intent.putExtra("tanggalawal", tanggalAwal);
                intent.putExtra("tanggalakhir", tanggalAkhir);
                break;
            default:
