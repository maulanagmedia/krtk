package gmedia.net.id.kartikaelektrik.ActivityHapusDenda;
...
public class DetailDendaCustomerActivity extends AppCompatActivity {

    private SessionManager session;
    private Context context;
    private ListPiutangDendadapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_denda_customer);
    ...
    private void initUI() {
        ...
        tvSave.setText("Proses");
        pbLoading = (ProgressBar) findViewById(R.id.pb_loading);

        adapter = new ListPiutangDendadapter((Activity) context, masterList);
    ...
    public void saveData() {
        ...
        ApiVolley apiVolley = new ApiVolley(getApplicationContext(), jBody, "POST", ServerURL.savePengajuanHapusDenda, "", "", 0, new ApiVolley.VolleyCallback() {
            @Override
    ...
    private void initData() {
        ...
        ApiVolley restService = new ApiVolley(context, jBody, "POST", ServerURL.getNotaCustomerDenda, "", "", 0,
