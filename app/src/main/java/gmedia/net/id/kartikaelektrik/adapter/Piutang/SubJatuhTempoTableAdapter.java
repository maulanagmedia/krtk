...
public class SubJatuhTempoTableAdapter extends ArrayAdapter {
    ...
    public SubJatuhTempoTableAdapter(Activity context, int resource, List items) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.adapter_sub_jatuh_tempo, null);
